...
if (isset($_POST['simpan'])) {
  ...
  $query = "
    ...
    VALUES ('$id', '$nama', '$deskripsi', '$kategori', '$harga_sewa', '$foto', 'tersedia')
  ";
      ...
      <div class="card p-4">
        ...
        <form method="post" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <input type="number" name="harga_sewa" class="form-control" placeholder="Masukkan harga_sewa sewa" required>
          </div>
          <div class="mb-3">
